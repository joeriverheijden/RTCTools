...
#        goals.append(MinimizeCostsGoal(self))
    ...
    def post(self):
        ...
        axarr[0].plot(times, results['Afdeling1.HQ.H'], label='Afdeling 1',
                      linewidth=2, color='b')
        ...
        axarr[0].set_ylim(-4.80, -4.40)

        axarr[1].set_ylabel('Water level\n[m]')
        axarr[1].plot(times, results['Afdeling2.HQ.H'], label='Afdeling 2',
                      linewidth=2, color='b')
        axarr[1].plot(times, self.wl_max2 * np.ones_like(times), label='Afdeling2 Max',
                      linewidth=2, color='r', linestyle='--')
        axarr[1].plot(times, self.wl_min2 * np.ones_like(times), label='Afdeling2 Min',
                      linewidth=2, color='g', linestyle='--')
        # ymin, ymax = axarr[1].get_ylim()
        axarr[1].set_ylim(-5.60, -5.20)

        axarr[2].set_ylabel('Water level\n[m]')
        axarr[2].plot(times, results['Afdeling3.HQ.H'], label='Afdeling 3',
                      linewidth=2, color='b')
        axarr[2].plot(times, self.wl_max3 * np.ones_like(times), label='Afdeling3 Max',
                      linewidth=2, color='r', linestyle='--')
        axarr[2].plot(times, self.wl_min3 * np.ones_like(times), label='Afdeling3 Min',
                      linewidth=2, color='g', linestyle='--')
        # ymin, ymax = axarr[2].get_ylim()
        axarr[2].set_ylim(-6.50, -5.90)

        axarr[3].plot(times, results['Afdeling4.HQ.H'], label='Afdeling 4',
                      linewidth=2, color='b')
        axarr[3].plot(times, self.wl_max4 * np.ones_like(times), label='Afdeling4 Max',
                      linewidth=2, color='r', linestyle='--')
        axarr[3].plot(times, self.wl_min4 * np.ones_like(times), label='Afdeling4 Min',
                      linewidth=2, color='g', linestyle='--')
        # ymin, ymax = axarr[3].get_ylim()
        axarr[3].set_ylim(-7, -6.40)

        axarr[4].set_ylabel('Water level\n[m]')
        axarr[4].plot(times, self.get_timeseries('Waddenzee_H', 0).values, label='Waddenzee',
                      linewidth=2, color='b')
        # ymin, ymax = axarr[4].get_ylim()
        axarr[4].set_ylim(-1.5, 1)

        axarr[4].set_ylabel('Water level\n[m]')
        axarr[4].plot(times, self.get_timeseries('IJsselmeer_H', 0).values, label='IJsselmeer',
                      linewidth=2, color='r')
        # ymin, ymax = axarr[4].get_ylim()
        axarr[4].set_ylim(-1.5, 1)

        axarr[5].set_ylabel('Energy price\n[EUR/kWh]')
        axarr[5].step(times, self.get_timeseries('energy_price', 0).values, label='Energy price',
                      linewidth=2, color='c')
        ymin, ymax = axarr[5].get_ylim()
        axarr[5].set_ylim(-0.1, ymax + 0.1)

        axarr[6].set_ylabel('Discharge\n[$\mathdefault{m^3\!/s}$]')
        axarr[6].step(times, results['leemanspumpingstationafd1.pomp1.Q'], label='Leemans1 Pump 1',
                      linewidth=2, color='b')
        axarr[6].step(times, results['leemanspumpingstationafd1.pomp2.Q'], label='Leemans1 Pump 2',
                      linewidth=2, color='r')
        axarr[6].plot(times, self.get_timeseries('RR_afdeling1_Q', 0).values, label='Inflow afdeling 1',
                      linewidth=2, color='g')
        ymin, ymax = axarr[6].get_ylim()

        axarr[7].set_ylabel('Discharge\n[$\mathdefault{m^3\!/s}$]')
        axarr[7].step(times, results['leemanspumpingstationafd3.pomp1.Q'], label='Leemans2 Pump 1',
                      linewidth=2, color='b')
        axarr[7].step(times, results['leemanspumpingstationafd3.pomp2.Q'], label='Leemans2 Pump 2',
                      linewidth=2, color='r')
        axarr[7].step(times, results['lelypumpingstationafd3.pomp1.Q'], label='Lely afd 3',
                      linewidth=2, color='c')
        axarr[7].plot(times, self.get_timeseries('RR_afdeling3_Q', 0).values, label='Inflow afdeling 3',
                      linewidth=2, color='g')
        ymin, ymax = axarr[7].get_ylim()

        axarr[8].set_ylabel('Discharge\n[$\mathdefault{m^3\!/s}$]')
        axarr[8].step(times, results['slootvaartpumpingstation.pomp1.Q'], label='Slootvaart Pump 1',
                      linewidth=2, color='b')
        axarr[8].step(times, results['slootvaartpumpingstation.pomp2.Q'], label='Slootvaart Pump 2',
                      linewidth=2, color='r')
        axarr[8].step(times, results['lelypumpingstationafd2.pomp1.Q'], label='Lely afd 2',
                      linewidth=2, color='c')
        axarr[8].plot(times, self.get_timeseries('RR_afdeling2_Q', 0).values, label='Inflow afdeling 2',
                      linewidth=2, color='g')
        ymin, ymax = axarr[8].get_ylim()

        axarr[9].set_ylabel('Discharge\n[$\mathdefault{m^3\!/s}$]')
        axarr[9].step(times, results['hoekvaartpumpingstation.pomp1.Q'], label='Hoekvaart Pump 1',
                      linewidth=2, color='b')
        axarr[9].step(times, results['hoekvaartpumpingstation.pomp2.Q'], label='Hoekvaart Pump 2',
                      linewidth=2, color='r')
        axarr[9].step(times, results['lelypumpingstationafd4.pomp1.Q'], label='Lely afd 4',
                      linewidth=2, color='c')
        axarr[9].plot(times, self.get_timeseries('RR_afdeling4_Q', 0).values, label='Inflow afdeling 4',
                      linewidth=2, color='g')
        ymin, ymax = axarr[9].get_ylim()


        # axarr[9].set_ylabel('Pump speed\n[$\mathdefault{min^{-1}}$]')
        # axarr[9].step(times, results['leemanspumpingstationafd1.pomp1_speed'], label='Leemans Pump 1',
        #               linewidth=2, color='b')
        # axarr[9].step(times, results['leemanspumpingstationafd1.pomp2_speed'], label='Leemans Pump 2',
        #               linewidth=2, color='r')
        # ymin, ymax = axarr[9].get_ylim()
        #
        ...
        axarr[9].set_ylim(-0.05 * (ymax - ymin), ymax * 1.1)
        axarr[9].xaxis.set_major_formatter(mdates.DateFormatter('%H:%M'))
