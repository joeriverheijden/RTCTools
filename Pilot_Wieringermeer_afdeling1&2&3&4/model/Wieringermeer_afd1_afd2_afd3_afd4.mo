model Wieringermeer_afd1_afd2_afd3_afd4
  ...
  model LeemansPumpingStationAfd1
    ...
    model LeemansPump
      ...
      power_coefficients = {{  117400.8705,        417.8780,       4107.9561},
                            {   26113.4013,       -883.4755,          0.0000},
                            {      47.5011,          0.0000,          0.0000}},

      working_area = {{{      15.5809,         -3.9970,          0.0000},
                       {      -1.0000,          0.0000,          0.0000},
                       {       0.0000,          0.0000,          0.0000}},
                      {{      15.5809,         -3.9970,          0.0000},
                       {      -1.0000,          0.0000,          0.0000},
                       {       0.0000,          0.0000,          0.0000}},
                      {{       2.1087,          3.5391,          0.0000},
                       {      -1.0000,          0.0000,          0.0000},
                       {       0.0000,          0.0000,          0.0000}},
                      {{       0.1724,          0.5536,          0.0000},
                       {      -1.0000,          0.0000,          0.0000},
                       {       0.0000,          0.0000,          0.0000}}},

     speed_coefficients = {{     356.0000,          0.0000,         -0.0000},
                           {       0.0000,         -0.0000,          0.0000},
                           {      -0.0000,          0.0000,          0.0000}},
  ...
  model LeemansPumpingStationAfd3
    ...
    model LeemansPump
      extends Deltares.HydraulicStructures.PumpingStation.Pump(
            ...
            working_area = {{{      23.1468,         -5.4052,          0.0000},
                             {      -1.0000,          0.0000,          0.0000},
                             {       0.0000,          0.0000,          0.0000}},
                            {{      23.1468,         -5.4052,          0.0000},
                             {      -1.0000,          0.0000,          0.0000},
                             {       0.0000,          0.0000,          0.0000}},
                            {{       2.4417,          4.7470,          0.0000},
                             {      -1.0000,          0.0000,          0.0000},
                             {       0.0000,          0.0000,          0.0000}},
                            {{       0.3438,          1.1481,          0.0000},
                             {      -1.0000,          0.0000,          0.0000},
                             {       0.0000,          0.0000,          0.0000}}},

           speed_coefficients = {{     430.4000,          0.0000,         -0.0000},
                                 {       0.0000,         -0.0000,          0.0000},
                                 {      -0.0000,          0.0000,          0.0000}},
            working_area_direction = {-1, 1, 1, -1});
    end LeemansPump;
