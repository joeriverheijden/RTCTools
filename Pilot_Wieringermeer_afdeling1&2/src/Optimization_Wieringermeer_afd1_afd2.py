...
class Wieringermeer_afd1_afd2(PumpingStationMixin, GoalProgrammingMixin, PIMixin, ModelicaMixin,
    ...
    wl_min2, wl_max2 = (-5.30,-5.50)

    def __init__(self, *args, **kwargs):
        super(Wieringermeer_afd1_afd2, self).__init__(*args, **kwargs)
    ...
    def path_goals(self):
        goals = super(Wieringermeer_afd1_afd2, self).path_goals()
    ...
    def solver_options(self):
        options = super(Wieringermeer_afd1_afd2, self).solver_options()
        options['print_level'] = 2
        return options

    def post(self):
        super(Wieringermeer_afd1_afd2, self).post()
        ...
        powers1 = results['leemanspumpingstationafd1.pomp1__power'][1:] \
                 + results['leemanspumpingstationafd1.pomp2__power'][1:]

        powers2 = results['slootvaartpumpingstation.pomp1__power'][1:] \
                 + results['slootvaartpumpingstation.pomp2__power'][1:]

        total_power1 = sum(powers1)/1000
        print("Total power1 = {} kWh".format(total_power1))

        total_power2 = sum(powers2)/1000
        print("Total power2 = {} kWh".format(total_power2))
        ...
        axarr[3].step(times, results['leemanspumpingstationafd1.pomp1.Q'], label='Leemans Pump 1',
                      linewidth=2, color='b')
        axarr[3].step(times, results['leemanspumpingstationafd1.pomp2.Q'], label='Leemans Pump 2',
                      linewidth=2, color='r')
