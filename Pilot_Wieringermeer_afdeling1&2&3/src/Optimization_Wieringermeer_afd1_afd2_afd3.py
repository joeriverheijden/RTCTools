...
class Wieringermeer_afd1_afd2_afd3(PumpingStationMixin, GoalProgrammingMixin, PIMixin, ModelicaMixin,
    ...
    def __init__(self, *args, **kwargs):
        super(Wieringermeer_afd1_afd2_afd3, self).__init__(*args, **kwargs)
    ...
    def path_goals(self):
        goals = super(Wieringermeer_afd1_afd2_afd3, self).path_goals()
    ...
    def solver_options(self):
        options = super(Wieringermeer_afd1_afd2_afd3, self).solver_options()
        options['print_level'] = 2
        return options

    def post(self):
        super(Wieringermeer_afd1_afd2_afd3, self).post()
...
# Run
run_optimization_problem(Wieringermeer_afd1_afd2_afd3, base_folder='..')
